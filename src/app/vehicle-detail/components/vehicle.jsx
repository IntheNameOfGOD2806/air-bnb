...
const Vehicle = () => {
    ...
    const listingId = params?.vehicle;
                                ...
                                <div className="flex flex-col gap-5">
                                    ...
                                    <div className="flex flex-col gap-5">
                                        <div className="flex flex-col gap-3">
                                            ...
                                            <h3 className="text-2xl text-green-500 text-center font-bold">Thông tin xe</h3>
                                            {/* <SimpleEditor isView={true} content={currentListing?.description} /> */}
                                            <label htmlFor="" className="font-bold">Mô tả</label>
                                            <p>{currentListing?.description}</p>
                                            {/* sdt */}
                                            <label htmlFor="" className="font-bold">Số điện thoại liên hệ</label>
                                            <p>{currentListing?.locationData?.phone}</p>
                                            <ListingMap />
                                        </div>
                                    </div>
                                </div>
