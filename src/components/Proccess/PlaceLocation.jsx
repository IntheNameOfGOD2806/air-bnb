...
const PlaceLocation = ({isTour, isVehicle}) => {
  ...
  return (
    <div className="flex text-black flex-col items-center justify-center h-full gap-5">
      ...
      <p className="text-center">
        {isTour ? "Click chuột chọn vị trí tour của bạn" : isVehicle ? "Click chuột chọn vị trí xe của bạn" : "Click chuột chọn vị trí điểm lưu trú của bạn"}
      </p>
